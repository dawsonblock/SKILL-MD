# Canonical Karpathy Guidelines

This file is the canonical source for shared guideline content.

Workflow:

1. Edit this file.
2. Run `python3 scripts/sync_guidelines.py`.
...
- If something remains unclear after checking available evidence, name the blocker and ask.
