...
Guidelines are canonical in **[`docs/guidelines.md`](docs/guidelines.md)**.

When you change the four principles:
1. Edit **[`docs/guidelines.md`](docs/guidelines.md)** first.
